CLDF dataset of the Enggano word list from 1895 in Stokhof and Almanar’s
(1987) Holle List
================
...
Enggano](https://portal.sds.ox.ac.uk/Lexical_resources_for_Enggano), led
...
1987](#ref-stokhof-almanar-1987)) (if in APA 7<sup>th</sup>) and the
particular [released
version](https://github.com/engganolang/holle-list-enggano-1895/releases)
of this repository ([Rajeg 2023b](#ref-rajeg2023a)) (in
...
> of Oxford. Dataset. <https://doi.org/10.25446/oxford.23515788.v3>
...
This repository contains the digitised word list of the
...
1980](#ref-holleli1980)); this Enggano word list is included in the
...
[process the raw word
list](https://github.com/engganolang/holle-list-enggano-1895/blob/2.0.0/code/Enggano-Holle-List.R)
into tabular format, before being [merged with the main, New Basic List
(NBL) of the Holle
List](https://github.com/engganolang/holle-list-enggano-1895/blob/2.0.0/code/Enggano-Holle-List-with-NBL.R)
in Stockhof ([1980](#ref-holleli1980)), which provides the English and
Indonesian glosses of the Enggano forms; the NBL itself has been
[digitised and available
online](https://engganolang.github.io/digitised-holle-list/) as a
webpage (cf. [Rajeg 2023a](#ref-rajeg2023)).

Overall, the dataset in this repository is
[conformant](https://github.com/engganolang/holle-list-enggano-1895/actions?query=workflow%3ACLDF-validation)
to the specification of the
[*Wordlist*](https://github.com/cldf/cldf/tree/master/modules/Wordlist)
module in the [Cross-Linguistic Data Formats
(CLDF)](https://cldf.clld.org/) ([Forkel et al. 2018](#ref-forkel2018)),
and has been accepted into the
[*Lexibank*](https://zenodo.org/communities/lexibank/records?q=Enggano&l=list&p=1&s=10&sort=bestmatch)
community on
[Zenodo](https://zenodo.org/communities/lexibank/records?q=&l=list&p=1&s=10&sort=newest).

The latest released version of this GitHub repository (v2.0.0) is also
available on the
<a href="https://ora.ox.ac.uk/objects/uuid:070e5dd2-512f-4c2b-812d-f24bb944a81f" target="_blank">Oxford
Research Archive (ORA)</a>.

### Contributors notes

[Mary Dalrymple](https://www.ling-phil.ox.ac.uk/people/mary-dalrymple)
performed the OCR on the PDF source; Gede Primahadi W. Rajeg edited,
cleansed, and annotated the [OCR
output](https://github.com/engganolang/holle-list-enggano-1895/blob/2.0.0/data-raw/Enggano-Holle-List.txt);
[Utei Charaleghy
Pamphila](https://www.sit.edu/sit_faculty/utei-charaleghy-pamphila-ella-ma/)
did the second round of proof reading of the edited data before being
processed into a CLDF-conformant dataset.
